...
$(document).ready(function () {
	...
	$(".parentCheckAll").click(
        function () {
            var chk = $(this);
            var id = $(this).attr("group-id");
            var checkfun;
            if (id == undefined) {
                checkfun = $(".check-box").each(function () { $(this).prop('checked', chk.prop('checked')); });
                $.uniform.update(checkfun);
            }
            else {
                //.prop('checked',$.cookie('is-ajax')==='true' ? true : false);
                checkfun = $("#" + id + " input[type='checkbox']").each(function () {
	...
	$(document).on("click", ".confirm", function (e) {
	    var c_a = $(this);
	    bootbox.confirm(c_a.attr("title"), function (result) {
	        if (result) {
	            window.location = c_a.attr("href");
	        }
	    });
	    return false;
	});
	...
	//    if (bootbox.confirm($(this).attr("title")))
	//        return true;
	//    else return false;
	//});
	...
	{
		$('#bs-css').attr('href','//static.alipig.com/frame/charisma/css/bootstrap-'+theme_name+'.css');
	}
